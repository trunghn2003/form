...
<jasperReport xmlns="http://jasperreports.sourceforge.net/jasperreports" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://jasperreports.sourceforge.net/jasperreports http://jasperreports.sourceforge.net/xsd/jasperreport.xsd" name="1. Phieu DKDT Dai Hoc 2026_page_1" pageWidth="595" pageHeight="842" columnWidth="595" leftMargin="0" rightMargin="0" topMargin="0" bottomMargin="0" uuid="9c88892d-c90d-4eae-a334-77603ab8cf6a">
	...
	<field name="toHopMonCode" class="java.lang.String"/>
	<detail>
		<band height="842" splitType="Stretch">
			...
			<staticText>
				...
				<text><![CDATA[PHIẾU ĐĂNG KÝ SƠ TUYỂN, TUYỂN SINH ĐẠI HỌC, CAO ĐẲNG QUÂN SỰ NĂM 2026]]></text>
			</staticText>
			<staticText>
			...
			<staticText>
				...
				<text><![CDATA[- Tổ hợp các môn đăng ký xét tuyển:]]></text>
			</staticText>
			<staticText>
			...
			<textField isBlankWhenNull="true">
				...
				<textFieldExpression><![CDATA[($F{noiNopHsCityName} == null || "null".equals($F{noiNopHsCityName}) || "undefined".equals($F{noiNopHsCityName})) ? "" : $F{noiNopHsCityName}]]></textFieldExpression>
			</textField>
			<textField isBlankWhenNull="true">
				<reportElement positionType="Float" x="138" y="150" width="301" height="16" uuid="a4d1523a-1b80-4d82-99b2-2c3e75af94b4"/>
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[($F{noiNopHsWardName} == null || "null".equals($F{noiNopHsWardName}) || "undefined".equals($F{noiNopHsWardName})) ? "" : $F{noiNopHsWardName}]]></textFieldExpression>
			</textField>
			<textField isBlankWhenNull="true">
			...
			<textField isBlankWhenNull="true">
				...
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[($F{truongName} == null || "null".equals($F{truongName}) || "undefined".equals($F{truongName})) ? "" : $F{truongName}]]></textFieldExpression>
			</textField>
			<textField isBlankWhenNull="true">
			...
			<textField isBlankWhenNull="true">
				...
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[($F{hoVaTen} == null || "null".equals($F{hoVaTen}) || "undefined".equals($F{hoVaTen})) ? "" : $F{hoVaTen}.trim().toUpperCase()]]></textFieldExpression>
			</textField>
			<textField isBlankWhenNull="true">
			...
			<textField isBlankWhenNull="true">
				...
				<textFieldExpression><![CDATA[
					(($F{noiKhaiSinhChiTiet} == null || "null".equals($F{noiKhaiSinhChiTiet}) || "undefined".equals($F{noiKhaiSinhChiTiet})) ? "" : $F{noiKhaiSinhChiTiet}) + 
					(($F{noiKhaiSinhWardName} == null || "null".equals($F{noiKhaiSinhWardName}) || "undefined".equals($F{noiKhaiSinhWardName})) ? "" : ", " + $F{noiKhaiSinhWardName}) + 
					(($F{noiKhaiSinhCityName} == null || "null".equals($F{noiKhaiSinhCityName}) || "undefined".equals($F{noiKhaiSinhCityName})) ? "" : ", " + $F{noiKhaiSinhCityName})
				]]></textFieldExpression>
			</textField>
			<textField isBlankWhenNull="true">
				...
				<textFieldExpression><![CDATA[
					(($F{thuongTruChiTiet} == null || "null".equals($F{thuongTruChiTiet}) || "undefined".equals($F{thuongTruChiTiet})) ? "" : $F{thuongTruChiTiet}) + 
					(($F{thuongTruWardName} == null || "null".equals($F{thuongTruWardName}) || "undefined".equals($F{thuongTruWardName})) ? "" : ", " + $F{thuongTruWardName}) + 
					(($F{thuongTruCityName} == null || "null".equals($F{thuongTruCityName}) || "undefined".equals($F{thuongTruCityName})) ? "" : ", " + $F{thuongTruCityName}) + 
			...
			<textField isBlankWhenNull="true">
				...
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[$F{danTocName}]]></textFieldExpression>
			</textField>
			<textField isBlankWhenNull="true">
			...
			<textField isBlankWhenNull="true">
				...
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[$F{tonGiaoName}]]></textFieldExpression>
			</textField>
			<textField isBlankWhenNull="true">
...
($F{tonGiaoName} == "Phật giáo" || $F{tonGiaoName} == "phật giáo") ? "1" : "2"]]></textFieldExpression>
			...
			<textField isBlankWhenNull="true">
				...
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[
					(($F{lop10TruongName} == null || "null".equals($F{lop10TruongName}) || "undefined".equals($F{lop10TruongName})) ? "" : $F{lop10TruongName}) + 
					", " + "Xã/Phường..." + ", " + 
					(($F{lop10CityName} == null || "null".equals($F{lop10CityName}) || "undefined".equals($F{lop10CityName})) ? "" : $F{lop10CityName})
				]]></textFieldExpression>
			</textField>
			<textField isBlankWhenNull="true">
				...
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[
					(($F{lop11TruongName} == null || "null".equals($F{lop11TruongName}) || "undefined".equals($F{lop11TruongName})) ? "" : $F{lop11TruongName}) + 
					", " + "Xã/Phường..." + ", " + 
					(($F{lop11CityName} == null || "null".equals($F{lop11CityName}) || "undefined".equals($F{lop11CityName})) ? "" : $F{lop11CityName})
				]]></textFieldExpression>
			</textField>
			<textField isBlankWhenNull="true">
				...
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[
					(($F{lop12TruongName} == null || "null".equals($F{lop12TruongName}) || "undefined".equals($F{lop12TruongName})) ? "" : $F{lop12TruongName}) + 
					", " + "Xã/Phường..." + ", " + 
					(($F{lop12CityName} == null || "null".equals($F{lop12CityName}) || "undefined".equals($F{lop12CityName})) ? "" : $F{lop12CityName})
				]]></textFieldExpression>
			</textField>
			<textField isBlankWhenNull="true">
			...
			<textField isBlankWhenNull="true">
				...
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[($F{khuVucNoiHocTHPTCode} == null || "null".equals($F{khuVucNoiHocTHPTCode}) || "undefined".equals($F{khuVucNoiHocTHPTCode})) ? "" : $F{khuVucNoiHocTHPTCode}]]></textFieldExpression>
			</textField>
			<textField isBlankWhenNull="true">
			...
			<textField isBlankWhenNull="true">
				...
				<textElement textAlignment="Center" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[$F{doiTuongSoTuyen}]]></textFieldExpression>
			</textField>
			<staticText>
			...
			<textField isBlankWhenNull="true">
				<reportElement x="202" y="234" width="160" height="16" uuid="99ea5415-6494-443a-91c5-86113745accd"/>
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[$F{toHopMonCode}]]></textFieldExpression>
			</textField>
		</band>
	</detail>
</jasperReport>
