	...
	<detail>
		<band height="842" splitType="Stretch">
			...
			<textField>
				...
				<textFieldExpression><![CDATA[$F{noiNopHsCityName}]]></textFieldExpression>
			</textField>
			<textField>
				<reportElement positionType="Float" x="138" y="150" width="301" height="16" uuid="a4d1523a-1b80-4d82-99b2-2c3e75af94b4"/>
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[$F{noiNopHsWardName}]]></textFieldExpression>
			</textField>
			<textField>
			...
			<textField>
				...
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[$F{truongName}]]></textFieldExpression>
			</textField>
			<textField>
			...
			<textField>
				...
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[$F{hoVaTen}.toUpperCase()]]></textFieldExpression>
			</textField>
			<textField>
			...
			<textField>
				...
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[($F{noiKhaiSinhChiTiet} == null || "null".equals($F{noiKhaiSinhChiTiet}) ? "" : $F{noiKhaiSinhChiTiet}) +
($F{noiKhaiSinhWardName} == null || "null".equals($F{noiKhaiSinhWardName}) ? "" : ", " + $F{noiKhaiSinhWardName}) +
($F{noiKhaiSinhCityName} == null || "null".equals($F{noiKhaiSinhCityName}) ? "" : ", " + $F{noiKhaiSinhCityName})]]></textFieldExpression>
			</textField>
			<textField>
				...
				<textFieldExpression><![CDATA[($F{thuongTruChiTiet} == null || "null".equals($F{thuongTruChiTiet}) ? "" : $F{thuongTruChiTiet}) +
($F{thuongTruWardName} == null || "null".equals($F{thuongTruWardName}) ? "" : ", " + $F{thuongTruWardName}) +
($F{thuongTruCityName} == null || "null".equals($F{thuongTruCityName}) ? "" : ", " + $F{thuongTruCityName}) +
", thuộc khu vực ưu tiên: "]]></textFieldExpression>
			</textField>
			<textField>
...
($F{tonGiaoName} == "Phật giáo" || $F{tonGiaoName} == "phật giáo") ? "1" : "2"]]></textFieldExpression>
			...
			<textField>
				...
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[$F{lop10TruongName} + ", " + "Xã/Phường..." + ", " + $F{lop10CityName}]]></textFieldExpression>
			</textField>
			<textField>
				<reportElement x="97" y="414" width="263" height="16" uuid="44de17b4-1294-4053-bdcc-ade3fe3022ad"/>
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[$F{lop11TruongName} + ", " + "Xã/Phường..." + ", " + $F{lop11CityName}]]></textFieldExpression>
			</textField>
			<textField>
				<reportElement x="97" y="429" width="263" height="16" uuid="39f71a5e-81f3-470b-9ef3-756bd5af4f96"/>
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[$F{lop12TruongName} + ", " + "Xã/Phường..." + ", " + $F{lop12CityName}]]></textFieldExpression>
			</textField>
			<textField>
			...
			<textField>
				...
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[$F{khuVucNoiHocTHPTCode}]]></textFieldExpression>
			</textField>
			<textField>
