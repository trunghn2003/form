...
<!-- Generated in Cursor: safe template, no custom scriptlet -->
<jasperReport xmlns="http://jasperreports.sourceforge.net/jasperreports"
	...
	<!-- Input fields (JSON keys should match eForm payload) -->
	...
	<field name="diemThiTHPTText" class="java.lang.String"/>
	<field name="diemThiCaoDangText" class="java.lang.String"/>
	<field name="doatGiaiText" class="java.lang.String"/>

	<!-- Dotted helpers -->
	<variable name="DOTS_SHORT" class="java.lang.String">
		<initialValueExpression><![CDATA["................................."]]></initialValueExpression>
	</variable>
	<variable name="DOTS_MEDIUM" class="java.lang.String">
		<initialValueExpression><![CDATA[".............................................................................."]]></initialValueExpression>
	</variable>
	<variable name="DOTS_LONG" class="java.lang.String">
		<initialValueExpression><![CDATA["................................................................................................................................................................"]]></initialValueExpression>
	</variable>

	<!-- Helper variable: reusable null-check macro (not supported in JR expressions, so we inline) -->

	<detail>
		<band height="842" splitType="Stretch">
			<property name="com.jaspersoft.studio.unit.height" value="px"/>

			<!-- Top right box "Mẫu số 01" -->
			<rectangle>
			...
			<textField>
				<reportElement x="60" y="200" width="495" height="16" uuid="39e0f1a2-3b4c-4d5e-6f70-8192a3b4c5d7"/>
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[
					"3. Dân tộc: " +
					(
			...
			<textField isStretchWithOverflow="true">
				<reportElement x="60" y="220" width="495" height="28" uuid="4af1a2b3-4c5d-4e6f-7081-92a3b4c5d6e7"/>
			...
			<textField>
				<reportElement x="60" y="258" width="495" height="16" uuid="5b02c3d4-5e6f-4708-8192-a3b4c5d6e7f8"/>
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[
			...
			<textField>
				<reportElement x="60" y="278" width="495" height="16" uuid="6c13d4e5-6f70-4819-92a3-b4c5d6e7f809"/>
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[
			...
			<textField>
				<reportElement x="60" y="300" width="495" height="16" uuid="7d24e5f6-7081-492a-a3b4-c5d6e7f8091a"/>
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[
			...
			<textField>
				<reportElement x="60" y="320" width="495" height="16" uuid="8e35f607-8192-4a3b-b4c5-d6e7f8091a2b"/>
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[
					"7. Đã tốt nghiệp: " +
					(
			...
			<textField>
				<reportElement x="60" y="340" width="495" height="16" uuid="9f460718-92a3-4b4c-c5d6-e7f8091a2b3c"/>
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[
			...
			<textField>
				<reportElement x="60" y="362" width="495" height="16" uuid="a0571829-a3b4-4c5d-d6e7-f8091a2b3c4d"/>
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[
			...
			<textField isStretchWithOverflow="true">
				<reportElement x="60" y="384" width="495" height="32" uuid="b168293a-b4c5-4d6e-e7f8-091a2b3c4d5e"/>
				<textElement textAlignment="Left" verticalAlignment="Top"/>
				<textFieldExpression><![CDATA[
					"9. Điểm các môn thi THPT: " +
					(
						($F{diemThiTHPTText} == null || $F{diemThiTHPTText}.trim().length() == 0 || "undefined".equalsIgnoreCase($F{diemThiTHPTText}.trim()) || "null".equalsIgnoreCase($F{diemThiTHPTText}.trim()))
							? $V{DOTS_LONG}
							: $F{diemThiTHPTText}
					)
				]]></textFieldExpression>
			...
			<!-- MỤC 10: FIX - dùng String.valueOf để tránh null concat -->
			<textField isStretchWithOverflow="true">
				<reportElement x="60" y="418" width="495" height="18" uuid="c2793a4b-c5d6-4e7f-8091-a2b3c4d5e6f7"/>
				<textElement textAlignment="Left" verticalAlignment="Top"/>
				<textFieldExpression><![CDATA[
					"10. Điểm thi đại học, cao đẳng, trung cấp (nếu có): " +
					(
						(String.valueOf($F{diemThiCaoDangText}).trim().length() == 0
							|| "null".equalsIgnoreCase(String.valueOf($F{diemThiCaoDangText}).trim())
							|| "undefined".equalsIgnoreCase(String.valueOf($F{diemThiCaoDangText}).trim()))
							? $V{DOTS_LONG}
							: String.valueOf($F{diemThiCaoDangText}).trim()
					)
				]]></textFieldExpression>
			</textField>

			<!-- MỤC 11: FIX - dùng String.valueOf để tránh null concat -->
			<textField>
				<reportElement x="60" y="440" width="495" height="16" uuid="d38a4b5c-d6e7-4f80-91a2-b3c4d5e6f708"/>
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[
					"11. Đoạt giải (nếu có): " +
					(
						(String.valueOf($F{doatGiaiText}).trim().length() == 0
							|| "null".equalsIgnoreCase(String.valueOf($F{doatGiaiText}).trim())
							|| "undefined".equalsIgnoreCase(String.valueOf($F{doatGiaiText}).trim()))
							? ($V{DOTS_SHORT} + "  môn " + $V{DOTS_SHORT})
							: String.valueOf($F{doatGiaiText}).trim()
					)
				]]></textFieldExpression>
			</textField>
			<staticText>
				<reportElement x="60" y="458" width="495" height="16" uuid="e49b5c6d-e7f8-4091-a2b3-c4d5e6f70819"/>
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
			...
			<!-- Cam đoan -->
			<staticText>
				<reportElement x="60" y="492" width="495" height="30" uuid="f5ac6d7e-f809-41a2-b3c4-d5e6f708192a"/>
			...
			<staticText>
				<reportElement x="60" y="524" width="495" height="45" uuid="06bd7e8f-091a-42b3-c4d5-e6f708192a3b"/>
			...
			<textField isStretchWithOverflow="true" isBlankWhenNull="true">
				<reportElement x="60" y="574" width="495" height="28" uuid="17ce8f90-1a2b-43c4-d5e6-f708192a3b4c"/>
				<textElement textAlignment="Left" verticalAlignment="Top"/>
				<textFieldExpression><![CDATA[
			...
			<!-- Signature -->
			<staticText>
				<reportElement x="335" y="640" width="220" height="18" uuid="28df901a-2b3c-44d5-e6f7-08192a3b4c5d"/>
				<textElement textAlignment="Center" verticalAlignment="Middle">
			...
			<staticText>
				<reportElement x="335" y="658" width="220" height="15" uuid="39e0a12b-3c4d-45e6-f708-192a3b4c5d6e"/>
				<textElement textAlignment="Center" verticalAlignment="Middle">
