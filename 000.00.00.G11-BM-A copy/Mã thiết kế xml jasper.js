	...
	<detail>
		<band height="842" splitType="Stretch">
			...
			<textField>
				...
				<textElement textAlignment="Left" verticalAlignment="Middle"/>
				<textFieldExpression><![CDATA[$F{noiKhaiSinhChiTiet} + ", " + $F{noiKhaiSinhWardName} + ", " + $F{noiKhaiSinhCityName}]]></textFieldExpression>
			</textField>
			<textField>
				...
				<textFieldExpression><![CDATA[$F{thuongTruChiTiet}+ ", " + $F{thuongTruWardName} + ", " + $F{thuongTruCityName} + ", thuộc khu vực ưu tiên: "]]></textFieldExpression>
			</textField>
			<textField>
